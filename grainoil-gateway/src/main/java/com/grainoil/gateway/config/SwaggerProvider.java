package com.grainoil.gateway.config;
 ...
 * @PackageName com.grainoil.gateway.config
 * @Description 
 * @Author daiz
...
public class SwaggerProvider implements SwaggerResourcesProvider
{
    ...
    public List<SwaggerResource> get()
    {
        ...
        gatewayProperties.getRoutes().stream().filter(routeDefinition -> routeDefinition.getId().equals("grainoil-system"))
