...
import com.grainoil.activiti.mapper.BizAuditMapper;
...
public class BizAuditServiceImpl implements IBizAuditService
{
    ...
    /* (non-Javadoc)
     * @see com.grainoil.activiti.service.IBizAuditService#getHistoryTaskList(com.grainoil.activiti.vo.HiTaskVo)
     */
    @Override
