package com.grainoil.generator.controller;
...
import com.grainoil.generator.service.IGenTableColumnService;
...
public class GenController extends BaseController
{
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=grainoil.zip");
