package com.grainoil.common.redis.aspect;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.grainoil.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.grainoil.common.redis.annotation.RedisEvict)")
