package com.grainoil.common.log.aspect;
...
import com.grainoil.common.log.enums.BusinessStatus;
import com.grainoil.common.log.event.SysOperLogEvent;
import com.grainoil.common.utils.AddressUtils;
...
import com.grainoil.common.utils.spring.SpringContextHolder;
...
{
    // 配置织入点
    @Pointcut("@annotation(com.grainoil.common.log.annotation.OperLog)")
